# jupyterlab_duckling_syntax_highlighting
...
```bash
pip install jupyterlab_duckling_syntax_highlighting
```
...
```bash
pip uninstall jupyterlab_duckling_syntax_highlighting
```
...
# Change directory to the jupyterlab_duckling_syntax_highlighting directory
...
folder is located. Then you can remove the symlink named `jupyterlab_duckling_syntax_highlighting` within that folder.
